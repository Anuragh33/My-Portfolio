...
import { experiences, proofPoints } from "@/lib/data";
    ...
    <div className="content-grid section-space">
          ...
          <Reveal key={`${experience.company}-${experience.role}`} delay={index * 0.06}>
            <article className="glass-panel-strong p-6 lg:p-8">
              <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
                <div>
                  <p className="font-mono text-xs uppercase tracking-[0.28em] text-[#5ed29c]">
                    {index === 0 ? "Current role" : "Previous role"}
                  </p>
                  <h2 className="mt-4 font-['Inter'] text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
                    {experience.role}
      ...
      <Reveal className="mt-10">
        <section className="glass-panel p-6">
          <p className="font-mono text-xs uppercase tracking-[0.28em] text-[#5ed29c]">Signals</p>
